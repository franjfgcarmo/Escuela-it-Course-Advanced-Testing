...
public class OrderDoubleMockTest
{
    ...
    public void TestFillingRemovesInventoryIfInStock()
    {
        ...
        warehouseMock
            .Verify(w => w.GetInventory(name), Times.Once);
        warehouseMock
            .Verify(w => w.Remove(name, amount), Times.Once);
        mailService
            .Verify(m => m.Send(It.IsAny<Message>()), Times.Never);
    }
    ...
    public void TestFillingDoesNotRemoveIfNotEnoughInStock()
    {
        ...
        warehouseMock
            .Verify(w => w.GetInventory(name), Times.Once);
        warehouseMock
            .Verify(w => w.Remove(name, amount), Times.Never);
        mailService
            .Verify(m => m.Send(It.IsAny<Message>()), Times.Once);
    }
}
